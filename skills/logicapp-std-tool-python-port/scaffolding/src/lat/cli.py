...
# from .commands.backup import register as _reg_backup; _reg_backup(workflow_app)
# from .commands.revert import register as _reg_revert; _reg_revert(workflow_app)
# from .commands.decode import register as _reg_decode; _reg_decode(workflow_app)
# ... etc.
